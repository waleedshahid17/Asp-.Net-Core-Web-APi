...
namespace CompanyEmployees.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public EmployeesController(IRepositoryManager repository, ILoggerManager logger,EmployeeLinks employeeLinks, IMapper mapper,IDataShaper<EmployeeDto> dataShaper)
        {
        ...
        EmployeeParameters employeeParameters)
        {
            ...
            {
                return BadRequest("The Parameters entered are invalid!!!");
            }

            var company = await _repository.Company.GetOneCompanyAsync(companyId, trackChanges: false);
            if (company == null)
            {
 ...
 EmployeeForUpdateDto employee)
        ...
        Guid id, [FromBody] JsonPatchDocument<EmployeeForUpdateDto> patchDoc)
        {
            ...
            var employeeEntity = HttpContext.Items["employee"] as Employee; var employeeToPatch = _mapper.Map<EmployeeForUpdateDto>(employeeEntity);
